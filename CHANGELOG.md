...
### Fixed
- Improved mobile sidebar scrolling to prevent browser bottom UI bars (like Safari or Chrome) from overlaying the theme switcher.
- Replaced flexbox auto margins with standard top margins in mobile sidebar for maximum compatibility.

## [1.1.2] - 2026-06-06

### Fixed
- Fixed mobile navbar sidebar content clipping and theme dropdown visibility on smaller screens by enabling scrollability and static inline layout.
